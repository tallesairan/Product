<div class="btn-group product-attribute">
...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[group_id]" class="col-sm-2 control-label">
                                        {!! trans('product::attribute.label.group_id')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[group_id]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
...
$(document).ready(function(){
    ...
    $(".product-attribute .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/product.attribute.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".product-attribute .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.product-attribute .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'product.attribute.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#product-attribute-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#product-attribute-list .btn-reset-filter').css('display', 'none');
