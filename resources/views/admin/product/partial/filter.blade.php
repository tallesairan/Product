...
<div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[model]" class="col-sm-2 control-label">
                                        {!! trans('product::product.label.model')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[model]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[featured]" class="col-sm-2 control-label">
                                        {!! trans('product::product.label.featured')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[featured]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[premium]" class="col-sm-2 control-label">
                                        {!! trans('product::product.label.premium')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::text('search[premium]')->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
