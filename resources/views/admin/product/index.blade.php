            ...
            <div class="tab-content">
                <table id="product-product-list" class="table table-striped data-table">
                    <thead class="list_head">
                        ...
                        <th data-field="manufacturer_id">{!! trans('product::product.label.manufacturer_id')!!}</th>
                    <th data-field="category_id">{!! trans('product::product.label.category_id')!!}</th>
                    <th data-field="model">{!! trans('product::product.label.model')!!}</th>
                    <th data-field="name">{!! trans('product::product.label.name')!!}</th>
                    ...
                    <th data-field="featured">{!! trans('product::product.label.featured')!!}</th>
                    <th data-field="premium">{!! trans('product::product.label.premium')!!}</th>
                    <th data-field="order">{!! trans('product::product.label.order')!!}</th>
                    </thead>
                </table>
            </div>
        </div>
