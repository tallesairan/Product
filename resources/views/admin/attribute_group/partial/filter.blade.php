<div class="btn-group product-attribute_group">
...
$(document).ready(function(){
    ...
    $(".product-attribute_group .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/product.attribute_group.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".product-attribute_group .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.product-attribute_group .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'product.attribute_group.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#product-attribute_group-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#product-attribute_group-list .btn-reset-filter').css('display', 'none');
