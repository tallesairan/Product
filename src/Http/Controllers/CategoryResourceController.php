...
use Form;
use Figmax\Product\Http\Requests\CategoryRequest;
use Figmax\Product\Interfaces\CategoryRepositoryInterface;
use Figmax\Product\Models\Category;
...
class CategoryResourceController extends BaseController
{
    ...
    public function __construct(CategoryRepositoryInterface $category)
    {
        ...
        $this->repository
            ...
            ->pushCriteria(\Figmax\Product\Repositories\Criteria\CategoryResourceCriteria::class);
    }
    ...
    public function index(CategoryRequest $request)
    {
        ...
        if ($this->response->typeIs('json')) {
            ...
            return $this->repository
                ->setPresenter(\Figmax\Product\Repositories\Presenter\CategoryPresenter::class)
                ->$function();
        }
