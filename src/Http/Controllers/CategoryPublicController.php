...
class CategoryPublicController extends BaseController
{
     ...
     * Constructor.
     *
     * @param type \Figmax\Category\Interfaces\CategoryRepositoryInterface $category
     *
     * @return type
     */
    ...
    protected function show($slug)
    {
        ...
        return $this->response->title($$category->name . trans('$product::$category.name'))
            ->view('$product::public.category.show')
