...
use Form;
use Figmax\Product\Http\Requests\ProductRequest;
...
class ProductResourceController extends BaseController
{
    ...
    public function __construct(ProductRepositoryInterface $product)
    {
        ...
        $this->repository
            ...
            ->pushCriteria(\Figmax\Product\Repositories\Criteria\ProductResourceCriteria::class);
    }
    ...
    public function index(ProductRequest $request)
    {
        ...
        if ($this->response->typeIs('json')) {
            ...
            return $this->repository
                ->setPresenter(\Figmax\Product\Repositories\Presenter\ProductPresenter::class)
                ->$function();
        }
