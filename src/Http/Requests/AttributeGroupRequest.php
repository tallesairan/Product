...
namespace Figmax\Product\Http\Requests;
...
class AttributeGroupRequest extends FormRequest
{
    ...
    {
        $this->model = $this->route('attribute_group');

        if (is_null($this->model)) {
            // Determine if the user is authorized to access attribute_group module,
    ...
    {
        return user()->canDo('product.attribute_group.view');
    }
}
